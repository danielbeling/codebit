...
export default function CategoryPage() {
  ...
  for (let i = 1; i <= Math.ceil(allblog / perPage); i++) {  // Ajuste aqui para incluir a última página
    pageNumbers.push(i);
  }
        ...
        <div className="container">
          <div className="category_title">
            <div className="flex gap-1">
              <h1>{loading ? <div>Loading...</div> : publisedhblogs ? publisedhblogs && publisedhblogs[0]?.tags :
                publisedhblogs && publisedhblogs.tags}</h1>
              <span>{loading ? <div>0</div> : publisedhblogs.filter(blog => blog.tags).length}</span>
            </div>
            <p>
              ...
              {publisedhblogs.map((item) => {
                ...
                return <div className='cate_blog' key={item._id}>
                  ...
                  <div className="bloginfo mt-2">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem dignissimos molestiae totam in officiis harum!</p>
