      ...
      <div className="politica">
        <div className="privacy-policy-container">
          ...
          <p className="politica-text" id="esp">
            ...
            <Link href='https://danieldeveloper.vercel.app/' target='_blank' style={{ color: '#799fe2', textDecoration: 'none', margin: '1px' }}> Contato</Link> conosco através do nosso email de suporte.
          </p>
        </div>
      </div>
